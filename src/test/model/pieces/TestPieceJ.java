...
import model.pieces.boards.PieceJTestBoards;

public class TestPieceJ extends TestThreeWidePiece {

    @BeforeEach
    public void runBefore() {
        game = new Game();

        game.changeFirstInBag("J");
        game.nextPiece();
    ...
    public void testPieceConstructor() {
        ...
        TestConfig.assertConfigEquals(PieceConfigs.PIECE_J[0], piece.getConfiguration());
    }
    ...
    public void testHardDrop() {
        piece.hardDrop();
        assertBoardEqualsConfig("J", 4, 22, PieceConfigs.PIECE_J[0]);
    }
    ...
    public void testHardDropOnObstacle0() {
        ...
        assertBoardEqualsConfig("J", 3, 21, PieceConfigs.PIECE_J[0]);
    }
    ...
    public void testHardDropOnObstacle1() {
        ...
        assertBoardEqualsConfig("J", 5, 18, PieceConfigs.PIECE_J[0]);
    }
    ...
    public void testHardDropOnObstacle2() {
        ...
        assertBoardEqualsConfig("J", 6, 18, PieceConfigs.PIECE_J[0]);
    }
    ...
    public void testHardDropOnObstacle3() {
        ...
        assertBoardEqualsConfig("J", 7, 18, PieceConfigs.PIECE_J[0]);
    }
    ...
    private void testRotateCW0toR(String[][] board, boolean teleport, boolean successful) {
        ...
        if (successful) {
            ...
            assertEquals(PieceConfigs.PIECE_J[1], piece.getConfiguration());
        } else {
            assertEquals('0', piece.getOrientation());
            assertEquals(PieceConfigs.PIECE_J[0], piece.getConfiguration());
        }
    }
    ...
    public void testRotateCW0toR1() {
        testRotateCW0toR(PieceJTestBoards.CW_0_TO_R_1, true, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCW0toR2() {
        testRotateCW0toR(PieceJTestBoards.CW_0_TO_R_2, true, true);
    ...
    public void testRotateCW0toR3() {
        testRotateCW0toR(PieceJTestBoards.CW_0_TO_R_3, true, true);
        assertEquals(3, piece.getCenterX());
    ...
    public void testRotateCW0toR4() {
        testRotateCW0toR(PieceJTestBoards.CW_0_TO_R_4, true, true);
        assertEquals(4, piece.getCenterX());
    ...
    public void testRotateCW0toR5() {
        testRotateCW0toR(PieceJTestBoards.CW_0_TO_R_5, true, true);
        assertEquals(3, piece.getCenterX());
        assertEquals(10, piece.getCenterY());
    }
    ...
    public void testRotateCW0toR6() {
        testRotateCW0toR(PieceJTestBoards.FULL_0, true, false);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    private void testRotateCWRto2(String[][] board, boolean teleport, boolean successful) {
        ...
        if (successful) {
            ...
            assertEquals(PieceConfigs.PIECE_J[2], piece.getConfiguration());
        } else {
            assertEquals('R', piece.getOrientation());
            assertEquals(PieceConfigs.PIECE_J[1], piece.getConfiguration());
        }
    ...
    public void testRotateCWRto21() {
        testRotateCWRto2(PieceJTestBoards.CW_R_TO_2_1, true, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCWRto22() {
        testRotateCWRto2(PieceJTestBoards.CW_R_TO_2_2, true, true);
    ...
    public void testRotateCWRto23() {
        testRotateCWRto2(PieceJTestBoards.CW_R_TO_2_3, true, true);
        assertEquals(5, piece.getCenterX());
    ...
    public void testRotateCWRto24() {
        testRotateCWRto2(PieceJTestBoards.CW_R_TO_2_4, true, true);
        assertEquals(4, piece.getCenterX());
    ...
    public void testRotateCWRto25() {
        testRotateCWRto2(PieceJTestBoards.CW_R_TO_2_5, true, true);
        assertEquals(5, piece.getCenterX());
        assertEquals(6, piece.getCenterY());
    }
    ...
    public void testRotateCWRto26() {
        testRotateCWRto2(PieceJTestBoards.FULL_R, true, false);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    private void testRotateCW2toL(String[][] board, boolean teleport, boolean successful) {
        ...
        if (successful) {
            ...
            assertEquals(PieceConfigs.PIECE_J[3], piece.getConfiguration());
        } else {
            assertEquals('2', piece.getOrientation());
            assertEquals(PieceConfigs.PIECE_J[2], piece.getConfiguration());
        }
    ...
    public void testRotateCW2toL1() {
        testRotateCW2toL(PieceJTestBoards.CW_2_TO_L_1, true, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCW2toL2() {
        testRotateCW2toL(PieceJTestBoards.CW_2_TO_L_2, true, true);
        assertEquals(5, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCW2toL3() {
        testRotateCW2toL(PieceJTestBoards.CW_2_TO_L_3, true, true);
        assertEquals(5, piece.getCenterX());
        assertEquals(7, piece.getCenterY());
    }
    ...
    public void testRotateCW2toL4() {
        testRotateCW2toL(PieceJTestBoards.CW_2_TO_L_4, true, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(10, piece.getCenterY());
    }
    ...
    public void testRotateCW2toL5() {
        testRotateCW2toL(PieceJTestBoards.CW_2_TO_L_5, true, true);
        assertEquals(5, piece.getCenterX());
        assertEquals(10, piece.getCenterY());
    }
    ...
    public void testRotateCW2toL6() {
        testRotateCW2toL(PieceJTestBoards.FULL_2, true, false);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCWLto01() {
        testRotateCWLto0(PieceJTestBoards.CW_L_TO_0_1, true, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCWLto02() {
        testRotateCWLto0(PieceJTestBoards.CW_L_TO_0_2, true, true);
        assertEquals(3, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCWLto03() {
        testRotateCWLto0(PieceJTestBoards.CW_L_TO_0_3, true, true);
        assertEquals(3, piece.getCenterX());
        assertEquals(9, piece.getCenterY());
    }
    ...
    public void testRotateCWLto04() {
        testRotateCWLto0(PieceJTestBoards.CW_L_TO_0_4, true, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(6, piece.getCenterY());
    }
    ...
    public void testRotateCWLto05() {
        testRotateCWLto0(PieceJTestBoards.CW_L_TO_0_5, true, true);
        assertEquals(3, piece.getCenterX());
        assertEquals(6, piece.getCenterY());
    }
    ...
    public void testRotateCWLto06() {
        testRotateCWLto0(PieceJTestBoards.FULL_L, true, false);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCCW0toL1() {
        testRotateCCW0toL(PieceJTestBoards.CCW_0_TO_L_1, true, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCCW0toL2() {
        ...
        testRotateCCW0toL(PieceJTestBoards.CCW_0_TO_L_2, false, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCCW0toL3() {
        ...
        testRotateCCW0toL(PieceJTestBoards.CCW_0_TO_L_3, false, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCCW0toL4() {
        ...
        testRotateCCW0toL(PieceJTestBoards.CCW_0_TO_L_4, false, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCCW0toL5() {
        ...
        testRotateCCW0toL(PieceJTestBoards.CCW_0_TO_L_5, false, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCCW0toL6() {
        testRotateCCW0toL(PieceJTestBoards.FULL_0, true, false);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCounterCWLto21() {
        testRotateCounterCWLto2(PieceJTestBoards.CCW_L_TO_2_1, true, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCounterCWLto22() {
        ...
        testRotateCounterCWLto2(PieceJTestBoards.CCW_L_TO_2_2, false, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCounterCWLto23() {
        ...
        testRotateCounterCWLto2(PieceJTestBoards.CCW_L_TO_2_3, false, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCounterCWLto24() {
        ...
        testRotateCounterCWLto2(PieceJTestBoards.CCW_L_TO_2_4, false, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCounterCWLto25() {
        ...
        testRotateCounterCWLto2(PieceJTestBoards.CCW_L_TO_2_5, false, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCounterCWLto26() {
        testRotateCounterCWLto2(PieceJTestBoards.FULL_L, true, false);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCCW2toR1() {
        testRotateCCW2toR(PieceJTestBoards.CCW_2_TO_R_1, true, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCCW2toR2() {
        ...
        testRotateCCW2toR(PieceJTestBoards.CCW_2_TO_R_2, false, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCCW2toR3() {
        ...
        testRotateCCW2toR(PieceJTestBoards.CCW_2_TO_R_3, false, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCCW2toR4() {
        ...
        testRotateCCW2toR(PieceJTestBoards.CCW_2_TO_R_4, false, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCCW2toR5() {
        ...
        testRotateCCW2toR(PieceJTestBoards.CCW_2_TO_R_5, false, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCCW2toR6() {
        testRotateCCW2toR(PieceJTestBoards.FULL_2, true, false);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCounterCWRto01() {
        testRotateCounterCWRto0(PieceJTestBoards.CCW_R_TO_0_1, true, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCounterCWRto02() {
        ...
        testRotateCounterCWRto0(PieceJTestBoards.CCW_R_TO_0_2, false, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCounterCWRto03() {
        ...
        testRotateCounterCWRto0(PieceJTestBoards.CCW_R_TO_0_3, false, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCounterCWRto04() {
        ...
        testRotateCounterCWRto0(PieceJTestBoards.CCW_R_TO_0_4, false, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCounterCWRto05() {
        ...
        testRotateCounterCWRto0(PieceJTestBoards.CCW_R_TO_0_5, false, true);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
    ...
    public void testRotateCounterCWRto06() {
        testRotateCounterCWRto0(PieceJTestBoards.FULL_R, true, false);
        assertEquals(4, piece.getCenterX());
        assertEquals(8, piece.getCenterY());
    }
}